      ...
      <div className="relative rounded-3xl p-8 md:p-10 overflow-hidden shadow-2xl shadow-indigo-500/10 border border-white/40 isolate">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-10 px-5 py-3 bg-indigo-50/50 border border-indigo-100/50 rounded-2xl w-fit shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-900 font-bold text-sm">PhysiVault</span>
              </div>
